...
if __name__ == "__main__":
    ...
    print("Start saving")
    with open("./query_data_filtered_reversed/query_data_train_filtered.json", "w") as fout:
        for query in result_train_queries:
            fout.write(json.dumps(query) + "\n")
    
    with open("./query_data_filtered_reversed/query_data_valid_filtered.json", "w") as fout:
        for query in result_validation_queries:
            fout.write(json.dumps(query) + "\n")
    
    with open("./query_data_filtered_reversed/query_data_test_filtered.json", "w") as fout:
        for query in result_test_queries:
            fout.write(json.dumps(query) + "\n")
